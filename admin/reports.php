...
<script>
    document.querySelector('.generate-report-btn').addEventListener('click', function(event) {
    ...
    document.querySelectorAll('.pagination-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (page > 0 && page <= <?php echo $totalPages; ?>) {
                document.querySelector('#filter-form').appendChild(createHiddenInput('page', page));
